            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?=App::t('Вход пользователя')?></h3>
                    </div>
                        ...
                        <form role="form" method="post">
                            <fieldset>
                                ...
                                <div class="form-group<?=(($email_error)? ' has-error':'')?>">
                                  <label class="input-group">
                                    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-envelope-o  fa-fw fa-lg"></i></span>
                                    <input class="form-control" placeholder="<?=App::t('E-mail')?>" name="email" type="text" value="<?=Request::post('email')?>">
                                  </label>
                                </div>
                                <div class="form-group">
                                  <div class="input-group">
                                    <i class="fa fa-warning" style="color: #e00e18"></i>
                                    <?=App::t('E-mail необходим для оповещений')?>
                                  </div>
                                </div>
                                <?php } ?>
                                <?php if( !Request::session('captcha_off') ) { ?>
